const Cover = () => {
  return (
    <div className='w-full lg:w-[50%] h-fit'>
      ...
      <h2 className='text-seccolor font-bold font-secfont text-2xl lg:text-3xl'>UX Engineer & Product Strategist</h2>
      <div className='flex flex-col gap-2.5 py-5'>
        <p className='text-seccolor text-xl font-prifont'>Mi pasión es construir el puente donde el diseño de producto y el código se encuentran para crear soluciones escalables.</p>
